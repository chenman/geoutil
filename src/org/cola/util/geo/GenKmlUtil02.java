...
public class GenKmlUtil02 {
	...
	public static void main(String[] args) throws IOException {
		...
		// Ѱ��Ŀ¼��ȡ�ļ�
		File excelFile = new File("doc/404p.xlsx");
		...
		for (int rowNum = 1; rowNum <= xssfSheet.getLastRowNum(); rowNum++) {
			 ...
			 * <href>http://weixin.hui12580.cn:8090/ATPtest/red-pushpin.png</href> </Icon>
			 * <OvIcon>1</OvIcon> <OvIconNum>0</OvIconNum> <color>ffffffff</color>
			 * <scale>1.0</scale> </IconStyle> </Style>
			 */
			Element iconStyle = style.addElement("IconStyle");
			String check = getValue(xssfRow.getCell(3)).trim();
			if ("��".endsWith(check)) {
				iconStyle.addElement("Icon").addElement("href")
						.addText("http://weixin.hui12580.cn:8090/ATPtest/red-pushpin.png");
			} else {
				iconStyle.addElement("Icon").addElement("href")
				.addText("http://weixin.hui12580.cn:8090/ATPtest/unchecked.png");
			}
		...
		// ��ĳ�ڵ�����Ժ�ֵд��xml�ĵ���
		XMLWriter writer = new XMLWriter(new FileWriter("doc/404p.kml"), format);
		writer.write(doc);
		writer.close();
	}
